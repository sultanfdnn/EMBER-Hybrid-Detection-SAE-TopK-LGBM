...
# --- MODEL BOYUTU / ZAMANLAMA yardımcıları ---
...
class KLLossLayer(layers.Layer):
    ...
    def call(self, inputs):
        ...
        self.add_loss(loss)
        # Bu katmanın çıktısı kullanılmayacak; grafiğe bağlamak için dummy döndürüyoruz
...
for fold, (train_index, test_index) in enumerate(skf.split(X, y), start=1):
    ...
    for veri_name, (X_train_curr, y_train_curr, X_test_curr) in datasets.items():
        ...
        if veri_name == "VAE":
            ...
            _ = KLLossLayer(beta, name="kl_loss")([mu, logvar])  # çıkış kullanılmıyor, sadece loss ekler

            # Sadece rekonstrüksiyon kaybını optimize et (KL add_loss ile eklendi)
