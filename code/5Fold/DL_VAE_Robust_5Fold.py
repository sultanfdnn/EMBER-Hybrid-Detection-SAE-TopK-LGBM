...
# ======================= TEMEL AYARLAR =========================
# Temsil modu: "VAE" veya "RPCA-64"
REP_MODE = "VAE"         # verı tmesılı
...
def _gmlp_block(x, dim_ff=256, dropout=0.1):
    h = LayerNormalization()(x)
    u = Dense(dim_ff, activation='relu')(h)      # candidate
    g = Dense(dim_ff, activation='sigmoid')(h)   # gate
